...
class YoloV1(nn.Module):
    ...
    def __init__(self, model_params, cnn_blocks, mlp_dict):
        ...
        self.resnet18 = nn.Sequential(*list(resnet18(weights=ResNet18_Weights.DEFAULT).children())[:-2])
...
if __name__ == '__main__':
    ...
    config_path = os.path.join(cwd, 'configurations', 'yolo_v1_resnet18.json')
